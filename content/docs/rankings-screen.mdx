...
**{'$'}0.02/request** (`billing_code: rankings_screen_v1`). Max 500 rows per call. For larger pulls or historical traversals, use the per-ticker [`/api/rankings`](/docs/api#rankings) endpoint or the daily zarr export.
