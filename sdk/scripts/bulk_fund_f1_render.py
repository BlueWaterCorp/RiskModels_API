...
def main() -> int:
    ...
    ap.add_argument(
        ...
        type=float,
        default=0.0,
        help="Maximum allowed error rate (0.0-1.0) before exit fails. Default 0.0 requires no errors.",
    )
    args = ap.parse_args()
    ...
    exit_ok = render_ok and (batch_upload is None or batch_upload.get("ok"))
