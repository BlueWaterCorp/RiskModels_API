...
const FILER_COLUMNS =
  "bw_filer_id, cik, lei, name, filer_type, filer_subtype, country, status, style_label, latest_report_date, latest_filing_date, latest_extracted_at, latest_aum_usd, aum_tier, latest_n_holdings, last_in_eligible_universe_at, n_funds_managed, metadata";
