...
export const CAPABILITIES: Capability[] = [
  ...
  },
  {
    ...
    description:
      "Cohort residual statistics over a date range, one series per cohort. This is the demeaning endpoint: request residual_mean at the level your residual is defined against (sector residuals demean within sector cohorts) and subtract it. Panel runs 2000-01-03 to present, though full factor richness begins around 2006. Each cohort reports proxied_fraction — the share of returned days whose factor came from a substitute instrument — because two sector cohorts are majority-proxied over long windows and a chart that hides that shows partly a different basket. Public scope is SPY + the 11 GICS sector SPDRs. link_fit_resid_sd is the residual standard deviation of the 252-day link regression (cohort factor on its parent) — a fit-quality and dispersion measure, NOT a standard error of linked_beta and not a total-uncertainty measure; never build confidence intervals from it. It replaced linked_beta_se, removed 2026-08-25.",
  ...
  },
  {
    ...
    description:
      "The addressable cohorts, their parent links, the variable catalogue, and the interpretation notes that govern correct use — including the no-intercept contract read directly from the store. Free discovery step; call this before /api/cohorts to learn what may be requested and what the numbers mean. link_fit_resid_sd is the residual standard deviation of the 252-day link regression (cohort factor on its parent) — a fit-quality and dispersion measure, NOT a standard error of linked_beta and not a total-uncertainty measure; never build confidence intervals from it. It replaced linked_beta_se, removed 2026-08-25.",
