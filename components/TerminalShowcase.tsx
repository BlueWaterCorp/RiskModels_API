...
const scenarioB: Scenario = {
  ...
  lines: [
    ...
    { id: 6, delayMs: 1040, content: <span>&nbsp;&nbsp;&nbsp;&nbsp;<span style={{ color: C.key }}>&quot;price_close&quot;</span><span style={{ color: C.dim }}>: </span><span style={{ color: C.num }}>950.25</span><span style={{ color: C.dim }}>,</span></span> }, // raw-field-ok: illustrative literal in a terminal animation; no vendor data read
